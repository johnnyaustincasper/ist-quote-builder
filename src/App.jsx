...
function WorkOrderSection({measurements, custName, custAddr, currentUser}) {
  ...
  function handlePrint() {
    ...
    var footerHtml = ''
      ...
      +'<thead><tr>'
      +'<th style="padding:5px 8px;border:1px solid #ccc;font-size:11px;background:#f0f0f0;">Employee</th>'
      +'<th style="padding:5px 8px;border:1px solid #ccc;font-size:11px;background:#f0f0f0;">SQ FT</th>'
      +'<th style="padding:5px 8px;border:1px solid #ccc;font-size:11px;background:#f0f0f0;">LABOR ($)</th>'
      +'</tr></thead><tbody>'
      +empRowsHtml
      ...
      +'<table style="width:100%;border-collapse:collapse;">'
      +'<thead><tr>'
      +'<th style="padding:5px 8px;border:1px solid #ccc;font-size:11px;background:#f0f0f0;">R-VALUE</th>'
      +'<th style="padding:5px 8px;border:1px solid #ccc;font-size:11px;background:#f0f0f0;">FOOTAGE</th>'
      +'<th style="padding:5px 8px;border:1px solid #ccc;font-size:11px;background:#f0f0f0;">COST</th>'
      +'</tr></thead><tbody>'+rSummaryRows+'</tbody></table>'
      +'</td>'
      +'</tr>'
      +'<tr><td colspan="2" style="text-align:center;font-size:11px;font-weight:700;padding-top:8px;letter-spacing:0.05em;border:none;">Work Order Must Be Filled Out Completely</td></tr>'
      +'</table>'
      +'</td></tr>';

    var html = '<!DOCTYPE html><html><head><title>Work Order #'+woNum+'</title>'
      +'<style>'
      +'*{box-sizing:border-box;}body{font-family:Arial,sans-serif;margin:0;padding:16px;color:#111;}h1{font-size:20px;font-weight:900;margin:0;}'
      +'table.page-table{width:100%;border-collapse:collapse;height:100%;}'
      +'table.page-table>thead td,table.page-table>tbody td{vertical-align:top;padding:0;border:none;}'
      +'table.page-table>tfoot td{vertical-align:bottom;padding:0;border:none;}'
      +'@media print{button{display:none;}@page{margin:0.5in;}}'
      +'</style></head><body>'
      +'<table class="page-table">'
      +'<thead><tr><td colspan="2" style="padding-bottom:12px;border:none;">'
      ...
      +'</div>'
      +'<table style="border-collapse:collapse;margin-bottom:12px;"><tr>'
      ...
      +'</tr></table>'
      +'</td></tr></thead>'
      +'<tbody><tr><td colspan="2" style="padding-bottom:12px;border:none;">'
      ...
      +'<div style="margin-bottom:12px;"><div style="font-size:11px;font-weight:700;text-transform:uppercase;margin-bottom:4px;">Notes</div><div style="border:1px solid #ccc;padding:8px;font-size:12px;min-height:40px;">'+notes+'</div></div>'
      +'</td></tr></tbody>'
